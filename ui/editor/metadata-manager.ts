                                    ...
                                    new Form({
                                        fields: [
                                            ...
                                            },
                                            {
                                                ...
                                                propKey: 'name',
                                                onChange: (newValue: string) => this.updateName(currentObject, newValue),
                                            },
                                            {
                                                type: 'checkbox',
                                                label: 'Public',
                                                value: currentObject.public,
                                                propKey: 'public',
                                                onChange: (newValue: boolean) => this.updatePublic(currentObject, newValue),
                                            },
                                            {
                                                type: 'text',
                                                label: 'Author',
                                                value: currentObject.author,
                                                propKey: 'author',
                                                isReadOnly: true
                                            },
                                            {
                                            ...
                                            },
                                            {
                                                type: 'text',
                                                label: 'Created',
                                                value: new Date(currentObject.created).toLocaleString(),
                                                propKey: 'created',
                                                isReadOnly: true
                                            },
                                            {
                                                type: 'text',
                                                label: 'Last Updated',
                                                value: new Date(currentObject.updated).toLocaleString(),
                                                propKey: 'updated',
                                                isReadOnly: true
                                            },
                                        ],
