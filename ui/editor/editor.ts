...
*   **Changes:**
    *   Implement methods for updating each metadata field in `NObject`. These methods will be called by the `Form` component when the user modifies the input fields.
